...
Doctrine_Manager::getInstance()->bindComponent('Models_Intranet_SummaryQueueFileHistory', 'intranet');

/**
 * Models_Intranet_Base_SummaryQueueFileHistory
 * 
 ...
 */
abstract class Models_Intranet_Base_SummaryQueueFileHistory extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('summary_queue_file_history');
