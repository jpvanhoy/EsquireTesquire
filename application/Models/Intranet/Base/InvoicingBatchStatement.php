...
Doctrine_Manager::getInstance()->bindComponent('Models_Intranet_InvoicingBatchStatement', 'intranet');

/**
 * Models_Intranet_Base_InvoicingBatchStatement
 * 
 ...
 */
abstract class Models_Intranet_Base_InvoicingBatchStatement extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('invoicing_batch_statement');
