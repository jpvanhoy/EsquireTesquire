...
/**
 * Models_Solaria_Base_BypassProductionReason
 * 
 ...
 */
abstract class Models_Solaria_Base_BypassProductionReason extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('BypassProductionReason');
