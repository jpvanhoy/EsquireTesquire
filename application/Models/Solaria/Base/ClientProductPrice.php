...
/**
 * Models_Solaria_Base_ClientProductPrice
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 * 
 * @property integer $ClientProductPriceID
 ...
 */
abstract class Models_Solaria_Base_ClientProductPrice extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('ClientProductPrice');
        $this->hasColumn('ClientProductPriceID', 'integer', 4, array(
             'type' => 'integer',
             'length' => '4',
             'fixed' => false,
             'unsigned' => false,
