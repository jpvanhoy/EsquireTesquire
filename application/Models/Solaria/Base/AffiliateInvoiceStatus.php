...
/**
 * Models_Solaria_Base_AffiliateInvoiceStatus
 * 
 ...
 */
abstract class Models_Solaria_Base_AffiliateInvoiceStatus extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('AffiliateInvoiceStatus');
