...
Doctrine_Manager::getInstance()->bindComponent('Models_Main_ItDocsPages', 'main');

/**
 * Models_Main_Base_ItDocsPages
 * 
 ...
 */
abstract class Models_Main_Base_ItDocsPages extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('it_docs_pages');
