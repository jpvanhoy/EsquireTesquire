...
Doctrine_Manager::getInstance()->bindComponent('Models_Main_Trackinghistory2', 'main');

/**
 * Models_Main_Base_Trackinghistory2
 * 
 ...
 */
abstract class Models_Main_Base_Trackinghistory2 extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('trackinghistory2');
