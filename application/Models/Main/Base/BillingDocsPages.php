...
Doctrine_Manager::getInstance()->bindComponent('Models_Main_BillingDocsPages', 'main');

/**
 * Models_Main_Base_BillingDocsPages
 * 
 ...
 */
abstract class Models_Main_Base_BillingDocsPages extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('billing_docs_pages');
