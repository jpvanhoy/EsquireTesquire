...
Doctrine_Manager::getInstance()->bindComponent('Models_Main_AffiliateLocations', 'main');

/**
 * Models_Main_Base_AffiliateLocations
 * 
 ...
 * @property integer $affiliateLocationID
 * 
 * @package    ##PACKAGE##
 ...
 */
abstract class Models_Main_Base_AffiliateLocations extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('affiliate_locations');
        ...
        $this->hasColumn('affiliateLocationID', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             'fixed' => false,
             'unsigned' => true,
