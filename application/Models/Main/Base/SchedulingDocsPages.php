...
Doctrine_Manager::getInstance()->bindComponent('Models_Main_SchedulingDocsPages', 'main');

/**
 * Models_Main_Base_SchedulingDocsPages
 * 
 ...
 */
abstract class Models_Main_Base_SchedulingDocsPages extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('scheduling_docs_pages');
