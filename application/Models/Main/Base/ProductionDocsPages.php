...
Doctrine_Manager::getInstance()->bindComponent('Models_Main_ProductionDocsPages', 'main');

/**
 * Models_Main_Base_ProductionDocsPages
 * 
 ...
 */
abstract class Models_Main_Base_ProductionDocsPages extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('production_docs_pages');
