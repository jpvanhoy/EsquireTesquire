...
Doctrine_Manager::getInstance()->bindComponent('Models_Main_WpPostmeta', 'main');

/**
 * Models_Main_Base_WpPostmeta
 * 
 ...
 */
abstract class Models_Main_Base_WpPostmeta extends Doctrine_Record
{
