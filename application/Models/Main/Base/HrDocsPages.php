...
Doctrine_Manager::getInstance()->bindComponent('Models_Main_HrDocsPages', 'main');

/**
 * Models_Main_Base_HrDocsPages
 * 
 ...
 */
abstract class Models_Main_Base_HrDocsPages extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('hr_docs_pages');
